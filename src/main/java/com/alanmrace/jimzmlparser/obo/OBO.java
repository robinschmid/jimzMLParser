...
public class OBO implements Serializable {
  ...
  public static final String MS_OBO_URI =
      "https://raw.githubusercontent.com/HUPO-PSI/psi-ms-CV/master/psi-ms.obo";
  public static final String MS_OBO_FULLNAME =
      "Proteomics Standards Initiative Mass Spectrometry Ontology";

  /** Location of the Units ontology. */
  public static final String UO_OBO_URI =
  ...
  /**
   * Generate ontology database from the specified .obo file. If the obo file specifies imports,
   * then load those imports from resources associated with the project. The path of the import is
   * ignored, with only the final name considered as the location of the resource.
   * 
  ...
  /**
   * Get the term from the ontology with the ID id. If no term is found with exactly the id
